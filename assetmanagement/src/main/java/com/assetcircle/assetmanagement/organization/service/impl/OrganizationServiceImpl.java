package com.assetcircle.assetmanagement.organization.service.impl;
...
import com.assetcircle.assetmanagement.exception.MobileNumberAlreadyExistsException;
import com.assetcircle.assetmanagement.exception.OrganizationNotFoundException;
import com.assetcircle.assetmanagement.organization.mapper.OrganizationMapper;
...
import com.assetcircle.assetmanagement.organization.repository.OrganizationRepository;
import com.assetcircle.assetmanagement.organization.service.OrganizationService;
...
public class OrganizationServiceImpl implements OrganizationService {
    ...
    public void registerOrganization(OrganizationDto organizationDto) {
        if (organizationDto != null) {
            ...
            OrganizationModel organizationModel = OrganizationMapper.INSTANCE.toOrganization(organizationDto);
            ...
            OrganizationMapper.INSTANCE.toOrganizationDto(registeredOrganization);
        } else {
    ...
    public Optional<OrganizationDto> getOrganizationByCode(String organizationCode) {
        ...
        if (byOrganizationCode.isPresent()){
            ...
            return Optional.ofNullable(byOrganizationCode.map(OrganizationMapper.INSTANCE::toOrganizationDto)
    ...
    public boolean updateOrganization(Long id, OrganizationDto organizationDto) {
        ...
        if (organizationOptional.isPresent()) {
            ...
            log.info("Organization updated successfully: {}", updatedOrganization);
             ...
             OrganizationMapper.INSTANCE.toOrganizationDto(updatedOrganization);
             isUpdated=true;
             return isUpdated;
        } else {
